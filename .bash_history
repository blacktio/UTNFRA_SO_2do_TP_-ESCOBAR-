...
cd
history -a
cp ~/.bash_history ~/UTN-FRA_SO_Examenes/
cd ~/UTN-FRA_SO_Examenes
tree -a ~/UTN-FRA_SO_Examenes/RTA_Examen_20260621
git add .
git commit -m "Punto E"
git push
rm -f Punto_A.sh Punto_B.sh Punto_C.sh Punto_D.sh README.md EscobarAltaUser-Groups.sh
git add RTA_Examen_20260621/
...
git remote set-url origin https://github.com/blacktio/UTNFRA_SO_2do_TP_-ESCOBAR-.git
git push origin master
...
cd ~
rm -rf REPO_FINAL
mkdir REPO_FINAL && cd REPO_FINAL
git clone https://github.com
git clone https://github.com/blacktio/UTNFRA_SO_2do_TP_-ESCOBAR-.git
ls -ls
cd UTNFRA_SO_2do_TP_-ESCOBAR-
git rm Punto_A.sh Punto_B.sh Punto_C.sh Punto_D.sh README.md
